const BlogPreview = () => {
  return (
    <div class='bg-white p-2 w-80 max-w-3xl sm:w-full sm:p-4 h-auto sm:h-64 rounded-2xl shadow-lg flex flex-col sm:flex-row gap-5 select-none'>
      <div
        style={{
          backgroundImage: `url("https://images.unsplash.com/photo-1426604966848-d7adac402bff?ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8bmF0dXJlfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60")`
        }}
      ...
      <div className='flex sm:flex-1 flex-col gap-2 p-1'>
        ...
        <p className='text-gray-500 text-sm sm:text-base line-clamp-3'>
          This is the desctiption for your card. This is really really long.
          This is used to describe the content of the card. I hope you like the
          design...
        </p>
